 ...
 */
@Component
public class BTransactionReadCommited {

    private static final Logger logger = LoggerFactory.getLogger(BTransactionReadCommited.class);
    ...
    public List<Map<String, Object>> getDataCommitted() {
        ...
        List<Map<String, Object>> maps = list = jdbcTemplate.queryForList("select * from t_admin_user");
        allData.addAll(maps);
